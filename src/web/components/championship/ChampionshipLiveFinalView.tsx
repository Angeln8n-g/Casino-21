  ...
  return (
    <div className="min-h-screen bg-slate-950 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto mb-8 relative rounded-3xl overflow-hidden bg-slate-900 border border-casino-gold/30">
        ...
        <div className="relative p-4 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-black text-white uppercase tracking-widest text-shadow-gold">KASINO21 CHAMPIONSHIP</h1>
          </div>
          
          <div className="flex gap-2.5 sm:gap-4 w-full sm:w-auto justify-center">
            <div className="bg-black/50 border border-white/10 rounded-xl p-3 sm:p-4 text-center flex-1 sm:flex-initial min-w-[100px] sm:min-w-[120px]">
              <div className="text-[9px] sm:text-[10px] text-gray-400 uppercase tracking-widest font-bold mb-1">Espectadores</div>
              <div className="text-xl sm:text-2xl font-black text-white flex items-center justify-center gap-2">
                <Eye className="w-4 h-4 sm:w-5 sm:h-5 text-casino-gold" />
                1,245
              </div>
            </div>
            <div className="bg-black/50 border border-white/10 rounded-xl p-3 sm:p-4 text-center flex-1 sm:flex-initial min-w-[100px] sm:min-w-[120px]">
              <div className="text-[9px] sm:text-[10px] text-gray-400 uppercase tracking-widest font-bold mb-1">Pozo Final</div>
