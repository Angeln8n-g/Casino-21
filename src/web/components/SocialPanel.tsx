        ...
        <div className="flex bg-black/40 p-1.5 rounded-2xl border border-white/5 shrink-0 overflow-x-auto custom-scrollbar shadow-inner">
          <button
            ...
            className={`flex-1 py-2 text-xs uppercase tracking-widest font-black rounded-xl transition-all relative whitespace-nowrap px-4 ${
              activeTab === 'friends' ? 'bg-white/10 text-casino-gold shadow-md border border-white/10' : 'text-gray-300 hover:text-white hover:bg-white/5'
            }`}
          >
            Amigos
            {tabCount > 0 && (
          ...
          <button
            ...
            className={`flex-1 py-2 text-xs uppercase tracking-widest font-black rounded-xl transition-all whitespace-nowrap px-4 ${
              activeTab === 'search' ? 'bg-white/10 text-casino-gold shadow-md border border-white/10' : 'text-gray-300 hover:text-white hover:bg-white/5'
            }`}
          >
            Buscar
          </button>
          <button
            ...
            className={`flex-1 py-2 text-xs uppercase tracking-widest font-black rounded-xl transition-all relative whitespace-nowrap px-4 ${
              activeTab === 'chat' ? 'bg-white/10 text-casino-gold shadow-md border border-white/10' : 'text-gray-300 hover:text-white hover:bg-white/5'
            }`}
          >
                ...
                <div className="relative shrink-0">
                  ...
                  {friendSearchQuery && (
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-300 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-casino-gold/50 focus-visible:outline-none rounded"
                    >
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="shrink-0 p-2 rounded-lg bg-white/5 text-gray-300 hover:text-casino-gold hover:bg-casino-gold/10 hover:border-casino-gold/30 border border-transparent transition-all md:opacity-0 md:group-hover:opacity-100 opacity-100 shadow-sm"
                          title="Chat privado"
                        >
              ...
              <div className="flex items-center justify-between shrink-0 mb-2">
                ...
                {activeChatFriendId && (
                  <button 
                    ...
                    className="text-[10px] text-gray-300 hover:text-casino-gold font-bold uppercase transition-colors flex items-center gap-1"
                  >
                    <span>←</span> Global
                  </button>
                )}
  ...
  return (
    <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-white/[0.08] overflow-hidden animate-fade-in" onClick={(e) => e.stopPropagation()} style={{ background: 'linear-gradient(135deg, rgba(30,41,59,0.97) 0%, rgba(2,6,23,0.99) 100%)', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.8), 0 0 50px rgba(251,191,36,0.1)' }}>
        <button onClick={onClose} className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-gray-300 hover:text-white transition-all z-10">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          {state === 'waiting' && (
            <div className="space-y-3">
              ...
              <button onClick={handleCancel} className="w-full py-2 rounded-xl bg-white/5 text-gray-300 hover:text-red-400 hover:bg-red-500/10 font-bold text-xs border border-white/10 transition-all">Cancelar</button>
            </div>
          )}
          {state === 'accepted' && (
          ...
          {state === 'expired' && (
            <div className="space-y-2">
              ...
              <button onClick={() => { setState('idle'); setInvitationId(null); }} className="w-full py-2 rounded-xl bg-white/5 text-gray-300 hover:text-white text-xs font-bold border border-white/10 transition-all">Intentar de nuevo</button>
            </div>
          )}
          {state === 'rejected' && (
            <div className="space-y-2">
